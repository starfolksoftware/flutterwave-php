...
final class ChargeUssdOptions extends OptionsAbstract
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->define('account_bank')
            ->allowedTypes('string')
            ->allowedValues(
                '044', '050', '070', '011', '214', '058', '030', '082', '221', '232', '032', '033', '215', '090110', '035', '057'
            )->info('The account bank of the customer.');
