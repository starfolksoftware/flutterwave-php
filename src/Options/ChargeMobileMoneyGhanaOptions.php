...
final class ChargeMobileMoneyGhanaOptions extends OptionsAbstract
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        ...
        $resolver->define('network')
            ->allowedTypes('string')
            ->allowedValues('MTN', 'VODAFONE', 'TIGO')
            ->info('The network to charge from');
